...
float4 textureX(sampler2D s, float2 uv) { return tex2Dlod(s,float4(uv,0,0)); }
// ...unfortunately biad tex funcs cannot be used in geom funcs then...
// - i dont see a way to do this bacause frag and vert shaders are compiled all at once in Cg - ?!
#endif
