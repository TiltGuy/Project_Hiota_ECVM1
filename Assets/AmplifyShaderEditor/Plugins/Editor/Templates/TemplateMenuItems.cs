...
namespace AmplifyShaderEditor
{
	public class TemplateMenuItems
	{
		...
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "fc15a739dc9e2ea41b32327ae1a48429" );
		}
		[MenuItem( "Assets/Create/Amplify Shader/Templates/UI-Default", false, 85 )]
		public static void ApplyTemplateTemplatesUIDefault()
		{
			AmplifyShaderEditorWindow.CreateConfirmationTemplateShader( "ab8dba92527044447b387be74bbad6f2" );
		}
