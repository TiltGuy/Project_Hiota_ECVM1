...
Shader "Mushroom"
{
	Properties
	{
		...
		[HDR]_EmissiveColor("Emissive Color", Color) = (0.5330188,0.9873227,1,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( _EmissiveColor * tex2D( _TextureSample1, uv_TextureSample1 ) ).rgb;
			o.Alpha = 1;
...
Node;AmplifyShaderEditor.ColorNode;6;-715.444,181.5552;Inherit;False;Property;_EmissiveColor;Emissive Color;3;1;[HDR];Create;True;0;0;0;False;0;False;0.5330188,0.9873227,1,0;8.675366,0.882676,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=BD4A4CD54A23FD8A5510D1D99CDFA3E6D8A70007