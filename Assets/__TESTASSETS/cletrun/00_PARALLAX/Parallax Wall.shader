...
Shader "Custom/Parallax BackWall"
{
	...
	SubShader
	{
		...
		SamplerState sampler_Back03;
		uniform sampler2D _Back02;
		SamplerState sampler_Back02;
		uniform sampler2D _Back01;
		SamplerState sampler_Back01;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 tex2DNode74 = tex2D( _Back03, Offset50 );
			float4 lerpResult113 = lerp( tex2D( _Back04, Offset115 ) , tex2DNode74 , tex2DNode74.a);
			float2 Offset53 = ( ( 0.4 - 1 ) * i.viewDir.xy * 1.0 ) + uv_TexCoord49;
			float4 tex2DNode72 = tex2D( _Back02, Offset53 );
			float4 lerpResult58 = lerp( lerpResult113 , tex2DNode72 , tex2DNode72.a);
			float2 Offset54 = ( ( 0.9 - 1 ) * i.viewDir.xy * 1.0 ) + uv_TexCoord49;
			float4 tex2DNode70 = tex2D( _Back01, Offset54 );
			float4 lerpResult59 = lerp( lerpResult58 , tex2DNode70 , tex2DNode70.a);
...
/*ASEBEGIN
Version=18703
-1920;2;1920;1019;1804.652;-279.9937;1.495161;True;False
...
Node;AmplifyShaderEditor.SamplerNode;74;-561.5524,388.1378;Inherit;True;Property;_Back03;Back03;14;0;Create;True;0;0;False;0;False;-1;6e2e42fe541a5e541bbb93149a59d382;fb805903b18db7b44b1b4195e1ef7a55;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;114;-555.8807,68.58895;Inherit;True;Property;_Back04;Back04;17;0;Create;True;0;0;False;0;False;-1;d877830f488945b4789a10c0efda1caf;d126f348f0b8afb4cbfd199269a716d3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;70;-524.069,1404.997;Inherit;True;Property;_Back01;Back01;13;0;Create;True;0;0;False;0;False;-1;9bc740ef2808f874294cd4d89bd0dc59;82d5d982e40b7dc47be08b54c67ac973;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;106;-326.1519,2223.442;Inherit;False;Property;_GradiantValues;GradiantValues;15;0;Create;True;0;0;False;0;False;0,0;1.55,1.48;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;125;2653.282,1656.544;Inherit;False;Property;_Vector0;Vector 0;16;0;Create;True;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
ASEEND*/
//CHKSM=C976EB296675D273875451AA243AE2775B96DC8C